...
//        AuthService.addMsgToDatabase(sender, null, str,"00.00");        //добавляем сообщение в базу
...
//        AuthService.addMsgToDatabase(sender, receiver, str,"00.00");    ////добавляем сообщение в базу
    ...
    public void subscribe(ClientHandler clientHandler){
        ...
        broadcastClientList();
//        clientHandler.sendMsg(AuthService.getMessagesFromDatabase(clientHandler.getNick()));    //звлекаем сообщения из базы
    }
